...
var SVGAsset = class {
  [$33]($$ = {}) {
    var $59;
    ($59 = $$.url) !== void 0 && (this.url = $59);
    ($59 = $$.meta) !== void 0 && (this.meta = $59);
  }
  constructor($$ = null) {
    this[$26]($$);
  }
  ...
  adoptNode(node) {
    ...
    if ((_a = this.meta) == null ? void 0 : _a.content) {
      for (let $87 = this.meta.attributes, $68 = 0, $78 = Object.keys($87), $96 = $78.length, k, v; $68 < $96; $68++) {
        k = $78[$68];
        v = $87[k];
    ...
    if (this[$342] != value ? (this[$342] = value, true) : false) {
      if (value) {
        if (value.adoptNode) {
          ...
          for (let $373 = value.attributes, $352 = 0, $363 = Object.keys($373), $383 = $363.length, k, v; $352 < $383; $352++) {
            k = $363[$352];
            v = $373[k];
...
var VirtualFragment = class extends Fragment {
  ...
  hasChildNodes() {
    for (let $265 = 0, $273 = iter$__3(this.childNodes), $283 = $273.length; $265 < $283; $265++) {
      let item = $273[$265];
...
var hydrator = new class {
  ...
  [$115]($$ = null, deep = true) {
    var $87;
    this.items = $$ && ($87 = $$.items) !== void 0 ? $87 : [];
    this.current = $$ && ($87 = $$.current) !== void 0 ? $87 : null;
    this.lastQueued = $$ && ($87 = $$.lastQueued) !== void 0 ? $87 : null;
    this.tests = $$ && ($87 = $$.tests) !== void 0 ? $87 : 0;
  }
  flush() {
    let item = null;
    if (false) {
...
var $225 = Symbol.for("#afterReconcile");
var $472 = Symbol.for("##up");
var $51 = Symbol.for("#placeChild");
var $532 = Symbol.for("#afterVisit");
var $632 = Symbol.for("#appendChild");
var $58 = Symbol();
var $264 = Symbol();
var $332 = Symbol();
var $372 = Symbol();
...
var PageHomeComponent = class extends Component {
  render() {
    var $119, $311, $411, $68 = this._ns_ || "", $78, $87, $106, $1110, $136, $147, $165, $174, $194, $204;
    $119 = this;
    $119[$217]();
    ($311 = $411 = 1, $119[$58] === 1) || ($311 = $411 = 0, $119[$58] = 1);
    (!$311 || $411 & 2) && $119.flagSelf$("ci-af");
    $311 || ($78 = createElement("a", $119, `ci_af ${$68}`, null));
    $311 || ($78.href = "https://www.youtube.com/channel/UCkY9t704HSIvgaP1zE4uklA");
    $311 || ($87 = createSVGElement("svg", $78, `ci_af ${$68}`, null));
    $311 || $87.set$("src", youtube_default2);
    ;
    ;
    $311 || ($106 = createElement("a", $119, `ci_af ${$68}`, null));
    $311 || ($106.href = "https://www.instagram.com/familyfriendlymikey/");
    $311 || ($1110 = createSVGElement("svg", $106, `ci_af ${$68}`, null));
    $311 || $1110.set$("src", instagram_default2);
    ;
    ;
    $311 || ($136 = createElement("a", $119, `ci_af ${$68}`, null));
    $311 || ($136.href = "https://github.com/familyfriendlymikey");
    $311 || ($147 = createSVGElement("svg", $136, `ci_af ${$68}`, null));
    $311 || $147.set$("src", github_default2);
    ;
    ;
    $311 || ($165 = createElement("a", $119, `ci_af ${$68}`, null));
    $311 || ($165.href = "JILU");
    $311 || ($174 = createElement("img", $165, `ci_af ${$68}`, null));
    $311 || ($174.src = jilu_default2);
    ;
    ;
    $311 || ($194 = createElement("a", $119, `ci_af ${$68}`, null));
    $311 || ($194.href = "FTO");
    $311 || ($204 = createElement("img", $194, `ci_af ${$68}`, null));
    $311 || ($204.src = fto_default2);
    ;
    ;
    $119[$225]($411);
    return $119;
...
var AppTabsComponent = class extends Component {
  render() {
    var $235, $244, $255, $273 = this._ns_ || "", $283, $294;
    $235 = this;
    $235[$217]();
    ($244 = $255 = 1, $235[$264] === 1) || ($244 = $255 = 0, $235[$264] = 1);
    (!$244 || $255 & 2) && $235.flagSelf$("ci-aq");
    $244 || ($283 = createElement("div", $235, `tab ci_aq ${$273}`, "HOME"));
    $244 || $283.on$(`click`, {$_: [function(e, $$) {
      return page = "home";
    }]}, this);
    ;
    $244 || ($294 = createElement("div", $235, `tab ci_aq ${$273}`, "LISTS"));
    $244 || $294.on$(`click`, {$_: [function(e, $$) {
      return page = "lists";
    }]}, this);
    ;
    $235[$225]($255);
...
var AppTableComponent = class extends Component {
  render() {
    var $302, $312, $323, $343 = this._ns_ || "", $352, $363, $392, $40, $41, $443, $453, $462, $482;
    $302 = this;
    $302[$217]();
    ($312 = $323 = 1, $302[$332] === 1) || ($312 = $323 = 0, $302[$332] = 1);
    (!$312 || $323 & 2) && $302.flagSelf$("ci-at");
    $312 || ($352 = createElement("div", $302, `header ci_at ${$343}`, "Favorites List"));
    ;
    ($363 = $302[$372]) || ($302[$372] = $363 = createElement("div", $302, `body ci_at ${$343}`, null));
    ($392 = $302[$382]) || ($302[$382] = $392 = createIndexedList(384, $363));
    $40 = 0;
    $41 = $392.$;
    for (let $423 = 0, $433 = iter$__7(this.data), $522 = $433.length; $423 < $522; $423++) {
      let text = $433[$423];
      ($453 = $462 = 1, $443 = $41[$40]) || ($453 = $462 = 0, $41[$40] = $443 = createElement("div", $392, `row ci_at ${$343}`, null));
      $453 || ($443[$472] = $392);
      $482 = text, $482 === $443[$50] && $453 || ($443[$492] = $443[$51]($443[$50] = $482, 384, $443[$492]));
      $40++;
    }
    ;
    $392[$532]($40);
...
var PageListsComponent = class extends Component {
  render() {
    var $542, $552, $562, $582 = this._ns_ || "", $59, $61, $622;
    $542 = this;
    $542[$217]();
    ($552 = $562 = 1, $542[$572] === 1) || ($552 = $562 = 0, $542[$572] = 1);
    (!$552 || $562 & 2) && $542.flagSelf$("ci-ax");
    ($61 = $622 = 1, $59 = $542[$60]) || ($61 = $622 = 0, $542[$60] = $59 = createComponent("app-table", $542, `${$582}`, null));
    $61 || ($59.data = [
      "Harry Potter",
      "Polaris",
      "Ali G",
...
var AppComponent = class extends Component {
  render() {
    var $732, $642, $652, $662, $68 = this._ns_ || "", $69, $71, $722, $752, $762, $78, $79;
    $642 = this;
    $642[$217]();
    ($652 = $662 = 1, $642[$672] === 1) || ($652 = $662 = 0, $642[$672] = 1);
    (!$652 || $662 & 2) && $642.flagSelf$("ci-az");
    ($71 = $722 = 1, $69 = $642[$70]) || ($71 = $722 = 0, $642[$70] = $69 = createComponent("app-tabs", $642, `${$68}`, null));
    $71 || !$69.setup || $69.setup($722);
    $69[$532]($722);
    $71 || $642[$632]($69);
    ;
    $732 = null;
    if (page == "lists") {
      ($752 = $762 = 1, $732 = $642[$742]) || ($752 = $762 = 0, $642[$742] = $732 = createComponent("page-lists", null, `${$68}`, null));
      $752 || ($732[$472] = $642);
      $752 || !$732.setup || $732.setup($762);
      $732[$532]($762);
    } else {
      ($78 = $79 = 1, $732 = $642[$77]) || ($78 = $79 = 0, $642[$77] = $732 = createComponent("page-home", null, `${$68}`, null));
      $78 || ($732[$472] = $642);
      $78 || !$732.setup || $732.setup($79);
      $732[$532]($79);
    }
    ;
    $642[$80] = $642[$51]($732, 0, $642[$80]);
    $642[$225]($662);
    return $642;
  }
};
defineTag("app", AppComponent, {});
mount((($842 = $852 = 1, $81 = $822[$832]) || ($842 = $852 = 0, $81 = $822[$832] = $81 = createComponent("app", null, null, null)), $842 || ($81[$472] = $822._), $842 || $822.sym || !$81.setup || $81.setup($852), $822.sym || $81[$532]($852), $81));
//__FOOT__
